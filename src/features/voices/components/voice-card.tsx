...
import { AlertDialogTitle, AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader } from "@/components/ui/alert-dialog";
            ...
            <div className="relative h-24 w-20 shrink-0 lg:h-30 lg:w-24">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <VoiceAvatar
                        seed={voice.id}
                        name={voice.name}
                        className="size-14 border-[1.5px] border-white shadow-xs lg:size-16"
                    />
                </div>
            </div>
                                    ...
                                    <AlertDialogAction
                                        ...
                                        onClick={(e) => {
                                            ...
                                            deleteMutation.mutate(
                                                { id: voice.id },
                                                { onSuccess: () => setShowDeleteDialogue(false) }
                                            );
                                        }}
                                    >
                                        {
